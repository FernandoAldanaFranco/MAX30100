...
const char* mqtt_server = "192.168.1.255"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
...
void reconnect() {
  ...
  while (!client.connected()) { // Pregunta si hay conexión
    ...
    if (client.connect("ESP32CAMClient")) { //Pregunta por el resultado del intento de conexión
      ...
      client.subscribe("codigoIoT/SIC/max30100"); // Esta función realiza la suscripción al tema
